...
func (sq *SubscriptionQuery) QueryCustomer() *PaymentCustomerQuery {
	query := (&PaymentCustomerClient{config: sq.config}).Query()
...
func (sq *SubscriptionQuery) WithCustomer(opts ...func(*PaymentCustomerQuery)) *SubscriptionQuery {
	query := (&PaymentCustomerClient{config: sq.config}).Query()
...
func (sq *SubscriptionQuery) loadCustomer(ctx context.Context, query *PaymentCustomerQuery, nodes []*Subscription, init func(*Subscription), assign func(*Subscription, *PaymentCustomer)) error {
