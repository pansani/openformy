...
func (ac *AnswerCreate) SetValue(s string) *AnswerCreate {
...
func (ac *AnswerCreate) SetResponseID(id int) *AnswerCreate {
	ac.mutation.SetResponseID(id)
	return ac
}
...
func (ac *AnswerCreate) createSpec() (*Answer, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.ResponseIDs(); len(nodes) > 0 {
		...
		_node.response_answers = &nodes[0]
